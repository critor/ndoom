...
void R_AddLine (seg_t*	line)
{
	...
	//Global variable, required by R_StoreWallRange
    curline = line;

	/*printf("v1 = %i, %i, ",line->v1->x>>16,line->v1->y>>16);
	printf("v2 = %i, %i, ",line->v2->x>>16,line->v2->y>>16);
	printf("angle = %i \n",line->angle>>ANGLETOFINESHIFT);*/
    ...
    if (!backsector)
	{
		...
		/*if (x1==252 && x2-1==274)
		{
			printf("!backsector, %i - %i, ", x1, x2-1);
			printf("v1 = %i, %i, ", line->v1->x>>16, line->v1->y>>16);
			printf("v2 = %i, %i \n", line->v2->x>>16, line->v2->y>>16);
		}*/
		//Note: textures are sorted alphabetically in the WAD, so 0=AASTINKY, 1=BIGDOOR1, 2=BIGDOOR2, etc.
...
void R_Subsector (int num)
{
    ...
    {
		//printf("frontsector->ceilingpic = %i \n",frontsector->ceilingpic);
