...
void A_BrainDie();
void A_BrainAwake();
void A_BrainSpit();             DIE, FUNCTION POINTERS!!!! DIE DIE DIE!!!
void A_SpawnSound();
void A_SpawnFly();
void A_BrainExplode();*/
...
state_t	states[NUMSTATES] = {
    ...
    {SPR_PUNG,0,1,TA_Lower,S_PUNCHDOWN,0,0},	// S_PUNCHDOWN
    {SPR_PUNG,0,1,TA_Raise,S_PUNCHUP,0,0},	// S_PUNCHUP
    {SPR_PUNG,1,4,0,S_PUNCH2,0,0},		// S_PUNCH1
    {SPR_PUNG,2,4,TA_Punch,S_PUNCH3,0,0},	// S_PUNCH2
    {SPR_PUNG,3,5,0,S_PUNCH4,0,0},		// S_PUNCH3
    {SPR_PUNG,2,4,0,S_PUNCH5,0,0},		// S_PUNCH4
    {SPR_PUNG,1,5,TA_ReFire,S_PUNCH,0,0},	// S_PUNCH5
    {SPR_PISG,0,1,TA_WeaponReady,S_PISTOL,0,0},// S_PISTOL
    {SPR_PISG,0,1,TA_Lower,S_PISTOLDOWN,0,0},	// S_PISTOLDOWN
    {SPR_PISG,0,1,TA_Raise,S_PISTOLUP,0,0},	// S_PISTOLUP
    {SPR_PISG,0,4,0,S_PISTOL2,0,0},	// S_PISTOL1
    {SPR_PISG,1,6,TA_FirePistol,S_PISTOL3,0,0},// S_PISTOL2
    {SPR_PISG,2,4,0,S_PISTOL4,0,0},	// S_PISTOL3
    {SPR_PISG,1,5,TA_ReFire,S_PISTOL,0,0},	// S_PISTOL4
    {SPR_PISF,32768,7,TA_Light1,S_LIGHTDONE,0,0},	// S_PISTOLFLASH
    {SPR_SHTG,0,1,TA_WeaponReady,S_SGUN,0,0},	// S_SGUN
    {SPR_SHTG,0,1,TA_Lower,S_SGUNDOWN,0,0},	// S_SGUNDOWN
    {SPR_SHTG,0,1,TA_Raise,S_SGUNUP,0,0},	// S_SGUNUP
    {SPR_SHTG,0,3,0,S_SGUN2,0,0},	// S_SGUN1
    {SPR_SHTG,0,7,TA_FireShotgun,S_SGUN3,0,0},	// S_SGUN2
    ...
    {SPR_SHTG,0,7,TA_ReFire,S_SGUN,0,0},	// S_SGUN9
    {SPR_SHTF,32768,4,TA_Light1,S_SGUNFLASH2,0,0},	// S_SGUNFLASH1
    {SPR_SHTF,32769,3,TA_Light2,S_LIGHTDONE,0,0},	// S_SGUNFLASH2
    {SPR_SHT2,0,1,TA_WeaponReady,S_DSGUN,0,0},	// S_DSGUN
    {SPR_SHT2,0,1,TA_Lower,S_DSGUNDOWN,0,0},	// S_DSGUNDOWN
    {SPR_SHT2,0,1,TA_Raise,S_DSGUNUP,0,0},	// S_DSGUNUP
    {SPR_SHT2,0,3,0,S_DSGUN2,0,0},	// S_DSGUN1
    {SPR_SHT2,0,7,TA_FireShotgun2,S_DSGUN3,0,0},	// S_DSGUN2
    {SPR_SHT2,1,7,0,S_DSGUN4,0,0},	// S_DSGUN3
    {SPR_SHT2,2,7,TA_CheckReload,S_DSGUN5,0,0},	// S_DSGUN4
    {SPR_SHT2,3,7,TA_OpenShotgun2,S_DSGUN6,0,0},	// S_DSGUN5
    {SPR_SHT2,4,7,0,S_DSGUN7,0,0},	// S_DSGUN6
    {SPR_SHT2,5,7,TA_LoadShotgun2,S_DSGUN8,0,0},	// S_DSGUN7
    {SPR_SHT2,6,6,0,S_DSGUN9,0,0},	// S_DSGUN8
    {SPR_SHT2,7,6,TA_CloseShotgun2,S_DSGUN10,0,0},	// S_DSGUN9
    {SPR_SHT2,0,5,TA_ReFire,S_DSGUN,0,0},	// S_DSGUN10
    {SPR_SHT2,1,7,0,S_DSNR2,0,0},	// S_DSNR1
    {SPR_SHT2,0,3,0,S_DSGUNDOWN,0,0},	// S_DSNR2
    {SPR_SHT2,32776,5,TA_Light1,S_DSGUNFLASH2,0,0},	// S_DSGUNFLASH1
    {SPR_SHT2,32777,4,TA_Light2,S_LIGHTDONE,0,0},	// S_DSGUNFLASH2
    {SPR_CHGG,0,1,TA_WeaponReady,S_CHAIN,0,0},	// S_CHAIN
    {SPR_CHGG,0,1,TA_Lower,S_CHAINDOWN,0,0},	// S_CHAINDOWN
    {SPR_CHGG,0,1,TA_Raise,S_CHAINUP,0,0},	// S_CHAINUP
    {SPR_CHGG,0,4,TA_FireCGun,S_CHAIN2,0,0},	// S_CHAIN1
    {SPR_CHGG,1,4,TA_FireCGun,S_CHAIN3,0,0},	// S_CHAIN2
    {SPR_CHGG,1,0,TA_ReFire,S_CHAIN,0,0},	// S_CHAIN3
    {SPR_CHGF,32768,5,TA_Light1,S_LIGHTDONE,0,0},	// S_CHAINFLASH1
    {SPR_CHGF,32769,5,TA_Light2,S_LIGHTDONE,0,0},	// S_CHAINFLASH2
    {SPR_MISG,0,1,TA_WeaponReady,S_MISSILE,0,0},	// S_MISSILE
    {SPR_MISG,0,1,TA_Lower,S_MISSILEDOWN,0,0},	// S_MISSILEDOWN
    {SPR_MISG,0,1,TA_Raise,S_MISSILEUP,0,0},	// S_MISSILEUP
    {SPR_MISG,1,8,TA_GunFlash,S_MISSILE2,0,0},	// S_MISSILE1
    {SPR_MISG,1,12,TA_FireMissile,S_MISSILE3,0,0},	// S_MISSILE2
    {SPR_MISG,1,0,TA_ReFire,S_MISSILE,0,0},	// S_MISSILE3
    {SPR_MISF,32768,3,TA_Light1,S_MISSILEFLASH2,0,0},	// S_MISSILEFLASH1
    {SPR_MISF,32769,4,0,S_MISSILEFLASH3,0,0},	// S_MISSILEFLASH2
    {SPR_MISF,32770,4,TA_Light2,S_MISSILEFLASH4,0,0},	// S_MISSILEFLASH3
    {SPR_MISF,32771,4,TA_Light2,S_LIGHTDONE,0,0},	// S_MISSILEFLASH4
    {SPR_SAWG,2,4,TA_WeaponReady,S_SAWB,0,0},	// S_SAW
    {SPR_SAWG,3,4,TA_WeaponReady,S_SAW,0,0},	// S_SAWB
    {SPR_SAWG,2,1,TA_Lower,S_SAWDOWN,0,0},	// S_SAWDOWN
    {SPR_SAWG,2,1,TA_Raise,S_SAWUP,0,0},	// S_SAWUP
    {SPR_SAWG,0,4,TA_Saw,S_SAW2,0,0},	// S_SAW1
    {SPR_SAWG,1,4,TA_Saw,S_SAW3,0,0},	// S_SAW2
    {SPR_SAWG,1,0,TA_ReFire,S_SAW,0,0},	// S_SAW3
    {SPR_PLSG,0,1,TA_WeaponReady,S_PLASMA,0,0},	// S_PLASMA
    {SPR_PLSG,0,1,TA_Lower,S_PLASMADOWN,0,0},	// S_PLASMADOWN
    {SPR_PLSG,0,1,TA_Raise,S_PLASMAUP,0,0},	// S_PLASMAUP
    {SPR_PLSG,0,3,TA_FirePlasma,S_PLASMA2,0,0},	// S_PLASMA1
    {SPR_PLSG,1,20,TA_ReFire,S_PLASMA,0,0},	// S_PLASMA2
    {SPR_PLSF,32768,4,TA_Light1,S_LIGHTDONE,0,0},	// S_PLASMAFLASH1
    {SPR_PLSF,32769,4,TA_Light1,S_LIGHTDONE,0,0},	// S_PLASMAFLASH2
    {SPR_BFGG,0,1,TA_WeaponReady,S_BFG,0,0},	// S_BFG
    {SPR_BFGG,0,1,TA_Lower,S_BFGDOWN,0,0},	// S_BFGDOWN
    {SPR_BFGG,0,1,TA_Raise,S_BFGUP,0,0},	// S_BFGUP
    {SPR_BFGG,0,20,TA_BFGsound,S_BFG2,0,0},	// S_BFG1
    {SPR_BFGG,1,10,TA_GunFlash,S_BFG3,0,0},	// S_BFG2
    {SPR_BFGG,1,10,TA_FireBFG,S_BFG4,0,0},	// S_BFG3
    {SPR_BFGG,1,20,TA_ReFire,S_BFG,0,0},	// S_BFG4
    {SPR_BFGF,32768,11,TA_Light1,S_BFGFLASH2,0,0},	// S_BFGFLASH1
    {SPR_BFGF,32769,6,TA_Light2,S_LIGHTDONE,0,0},	// S_BFGFLASH2
    ...
    {SPR_BFE1,32770,8,TA_BFGSpray,S_BFGLAND4,0,0},	// S_BFGLAND3
    ...
    {SPR_MISL,32769,8,TA_Explode,S_EXPLODE2,0,0},	// S_EXPLODE1
    ...
    {SPR_PLAY,6,4,TA_Pain,S_PLAY,0,0},	// S_PLAY_PAIN2
    {SPR_PLAY,7,10,0,S_PLAY_DIE2,0,0},	// S_PLAY_DIE1
    {SPR_PLAY,8,10,TA_PlayerScream,S_PLAY_DIE3,0,0},	// S_PLAY_DIE2
    {SPR_PLAY,9,10,TA_Fall,S_PLAY_DIE4,0,0},	// S_PLAY_DIE3
    ...
    {SPR_PLAY,15,5,TA_XScream,S_PLAY_XDIE3,0,0},	// S_PLAY_XDIE2
    {SPR_PLAY,16,5,TA_Fall,S_PLAY_XDIE4,0,0},	// S_PLAY_XDIE3
    ...
    {SPR_POSS,0,10,TA_Look,S_POSS_STND2,0,0},	// S_POSS_STND
    {SPR_POSS,1,10,TA_Look,S_POSS_STND,0,0},	// S_POSS_STND2
    {SPR_POSS,0,4,TA_Chase,S_POSS_RUN2,0,0},	// S_POSS_RUN1
    {SPR_POSS,0,4,TA_Chase,S_POSS_RUN3,0,0},	// S_POSS_RUN2
    {SPR_POSS,1,4,TA_Chase,S_POSS_RUN4,0,0},	// S_POSS_RUN3
    {SPR_POSS,1,4,TA_Chase,S_POSS_RUN5,0,0},	// S_POSS_RUN4
    {SPR_POSS,2,4,TA_Chase,S_POSS_RUN6,0,0},	// S_POSS_RUN5
    {SPR_POSS,2,4,TA_Chase,S_POSS_RUN7,0,0},	// S_POSS_RUN6
    {SPR_POSS,3,4,TA_Chase,S_POSS_RUN8,0,0},	// S_POSS_RUN7
    {SPR_POSS,3,4,TA_Chase,S_POSS_RUN1,0,0},	// S_POSS_RUN8
    {SPR_POSS,4,10,TA_FaceTarget,S_POSS_ATK2,0,0},	// S_POSS_ATK1
    {SPR_POSS,5,8,TA_PosAttack,S_POSS_ATK3,0,0},	// S_POSS_ATK2
    {SPR_POSS,4,8,0,S_POSS_RUN1,0,0},	// S_POSS_ATK3
    {SPR_POSS,6,3,0,S_POSS_PAIN2,0,0},	// S_POSS_PAIN
    {SPR_POSS,6,3,TA_Pain,S_POSS_RUN1,0,0},	// S_POSS_PAIN2
    {SPR_POSS,7,5,0,S_POSS_DIE2,0,0},	// S_POSS_DIE1
    {SPR_POSS,8,5,TA_Scream,S_POSS_DIE3,0,0},	// S_POSS_DIE2
    {SPR_POSS,9,5,TA_Fall,S_POSS_DIE4,0,0},	// S_POSS_DIE3
    ...
    {SPR_POSS,13,5,TA_XScream,S_POSS_XDIE3,0,0},	// S_POSS_XDIE2
    {SPR_POSS,14,5,TA_Fall,S_POSS_XDIE4,0,0},	// S_POSS_XDIE3
    ...
    {SPR_SPOS,0,10,TA_Look,S_SPOS_STND2,0,0},	// S_SPOS_STND
    {SPR_SPOS,1,10,TA_Look,S_SPOS_STND,0,0},	// S_SPOS_STND2
    {SPR_SPOS,0,3,TA_Chase,S_SPOS_RUN2,0,0},	// S_SPOS_RUN1
    {SPR_SPOS,0,3,TA_Chase,S_SPOS_RUN3,0,0},	// S_SPOS_RUN2
    {SPR_SPOS,1,3,TA_Chase,S_SPOS_RUN4,0,0},	// S_SPOS_RUN3
    {SPR_SPOS,1,3,TA_Chase,S_SPOS_RUN5,0,0},	// S_SPOS_RUN4
    {SPR_SPOS,2,3,TA_Chase,S_SPOS_RUN6,0,0},	// S_SPOS_RUN5
    {SPR_SPOS,2,3,TA_Chase,S_SPOS_RUN7,0,0},	// S_SPOS_RUN6
    {SPR_SPOS,3,3,TA_Chase,S_SPOS_RUN8,0,0},	// S_SPOS_RUN7
    {SPR_SPOS,3,3,TA_Chase,S_SPOS_RUN1,0,0},	// S_SPOS_RUN8
    {SPR_SPOS,4,10,TA_FaceTarget,S_SPOS_ATK2,0,0},	// S_SPOS_ATK1
    {SPR_SPOS,32773,10,TA_SPosAttack,S_SPOS_ATK3,0,0},	// S_SPOS_ATK2
    {SPR_SPOS,4,10,0,S_SPOS_RUN1,0,0},	// S_SPOS_ATK3
    {SPR_SPOS,6,3,0,S_SPOS_PAIN2,0,0},	// S_SPOS_PAIN
    {SPR_SPOS,6,3,TA_Pain,S_SPOS_RUN1,0,0},	// S_SPOS_PAIN2
    {SPR_SPOS,7,5,0,S_SPOS_DIE2,0,0},	// S_SPOS_DIE1
    {SPR_SPOS,8,5,TA_Scream,S_SPOS_DIE3,0,0},	// S_SPOS_DIE2
    {SPR_SPOS,9,5,TA_Fall,S_SPOS_DIE4,0,0},	// S_SPOS_DIE3
    ...
    {SPR_SPOS,13,5,TA_XScream,S_SPOS_XDIE3,0,0},	// S_SPOS_XDIE2
    {SPR_SPOS,14,5,TA_Fall,S_SPOS_XDIE4,0,0},	// S_SPOS_XDIE3
    ...
    {SPR_VILE,0,10,TA_Look,S_VILE_STND2,0,0},	// S_VILE_STND
    {SPR_VILE,1,10,TA_Look,S_VILE_STND,0,0},	// S_VILE_STND2
    {SPR_VILE,0,2,TA_VileChase,S_VILE_RUN2,0,0},	// S_VILE_RUN1
    {SPR_VILE,0,2,TA_VileChase,S_VILE_RUN3,0,0},	// S_VILE_RUN2
    {SPR_VILE,1,2,TA_VileChase,S_VILE_RUN4,0,0},	// S_VILE_RUN3
    {SPR_VILE,1,2,TA_VileChase,S_VILE_RUN5,0,0},	// S_VILE_RUN4
    {SPR_VILE,2,2,TA_VileChase,S_VILE_RUN6,0,0},	// S_VILE_RUN5
    {SPR_VILE,2,2,TA_VileChase,S_VILE_RUN7,0,0},	// S_VILE_RUN6
    {SPR_VILE,3,2,TA_VileChase,S_VILE_RUN8,0,0},	// S_VILE_RUN7
    {SPR_VILE,3,2,TA_VileChase,S_VILE_RUN9,0,0},	// S_VILE_RUN8
    {SPR_VILE,4,2,TA_VileChase,S_VILE_RUN10,0,0},	// S_VILE_RUN9
    {SPR_VILE,4,2,TA_VileChase,S_VILE_RUN11,0,0},	// S_VILE_RUN10
    {SPR_VILE,5,2,TA_VileChase,S_VILE_RUN12,0,0},	// S_VILE_RUN11
    {SPR_VILE,5,2,TA_VileChase,S_VILE_RUN1,0,0},	// S_VILE_RUN12
    {SPR_VILE,32774,0,TA_VileStart,S_VILE_ATK2,0,0},	// S_VILE_ATK1
    {SPR_VILE,32774,10,TA_FaceTarget,S_VILE_ATK3,0,0},	// S_VILE_ATK2
    {SPR_VILE,32775,8,TA_VileTarget,S_VILE_ATK4,0,0},	// S_VILE_ATK3
    {SPR_VILE,32776,8,TA_FaceTarget,S_VILE_ATK5,0,0},	// S_VILE_ATK4
    {SPR_VILE,32777,8,TA_FaceTarget,S_VILE_ATK6,0,0},	// S_VILE_ATK5
    {SPR_VILE,32778,8,TA_FaceTarget,S_VILE_ATK7,0,0},	// S_VILE_ATK6
    {SPR_VILE,32779,8,TA_FaceTarget,S_VILE_ATK8,0,0},	// S_VILE_ATK7
    {SPR_VILE,32780,8,TA_FaceTarget,S_VILE_ATK9,0,0},	// S_VILE_ATK8
    {SPR_VILE,32781,8,TA_FaceTarget,S_VILE_ATK10,0,0},	// S_VILE_ATK9
    {SPR_VILE,32782,8,TA_VileAttack,S_VILE_ATK11,0,0},	// S_VILE_ATK10
    ...
    {SPR_VILE,16,5,TA_Pain,S_VILE_RUN1,0,0},	// S_VILE_PAIN2
    {SPR_VILE,16,7,0,S_VILE_DIE2,0,0},	// S_VILE_DIE1
    {SPR_VILE,17,7,TA_Scream,S_VILE_DIE3,0,0},	// S_VILE_DIE2
    {SPR_VILE,18,7,TA_Fall,S_VILE_DIE4,0,0},	// S_VILE_DIE3
    ...
    {SPR_FIRE,32768,2,TA_StartFire,S_FIRE2,0,0},	// S_FIRE1
    {SPR_FIRE,32769,2,TA_Fire,S_FIRE3,0,0},	// S_FIRE2
    {SPR_FIRE,32768,2,TA_Fire,S_FIRE4,0,0},	// S_FIRE3
    {SPR_FIRE,32769,2,TA_Fire,S_FIRE5,0,0},	// S_FIRE4
    {SPR_FIRE,32770,2,TA_FireCrackle,S_FIRE6,0,0},	// S_FIRE5
    {SPR_FIRE,32769,2,TA_Fire,S_FIRE7,0,0},	// S_FIRE6
    {SPR_FIRE,32770,2,TA_Fire,S_FIRE8,0,0},	// S_FIRE7
    {SPR_FIRE,32769,2,TA_Fire,S_FIRE9,0,0},	// S_FIRE8
    {SPR_FIRE,32770,2,TA_Fire,S_FIRE10,0,0},	// S_FIRE9
    {SPR_FIRE,32771,2,TA_Fire,S_FIRE11,0,0},	// S_FIRE10
    {SPR_FIRE,32770,2,TA_Fire,S_FIRE12,0,0},	// S_FIRE11
    {SPR_FIRE,32771,2,TA_Fire,S_FIRE13,0,0},	// S_FIRE12
    {SPR_FIRE,32770,2,TA_Fire,S_FIRE14,0,0},	// S_FIRE13
    {SPR_FIRE,32771,2,TA_Fire,S_FIRE15,0,0},	// S_FIRE14
    {SPR_FIRE,32772,2,TA_Fire,S_FIRE16,0,0},	// S_FIRE15
    {SPR_FIRE,32771,2,TA_Fire,S_FIRE17,0,0},	// S_FIRE16
    {SPR_FIRE,32772,2,TA_Fire,S_FIRE18,0,0},	// S_FIRE17
    {SPR_FIRE,32771,2,TA_Fire,S_FIRE19,0,0},	// S_FIRE18
    {SPR_FIRE,32772,2,TA_FireCrackle,S_FIRE20,0,0},	// S_FIRE19
    {SPR_FIRE,32773,2,TA_Fire,S_FIRE21,0,0},	// S_FIRE20
    {SPR_FIRE,32772,2,TA_Fire,S_FIRE22,0,0},	// S_FIRE21
    {SPR_FIRE,32773,2,TA_Fire,S_FIRE23,0,0},	// S_FIRE22
    {SPR_FIRE,32772,2,TA_Fire,S_FIRE24,0,0},	// S_FIRE23
    {SPR_FIRE,32773,2,TA_Fire,S_FIRE25,0,0},	// S_FIRE24
    {SPR_FIRE,32774,2,TA_Fire,S_FIRE26,0,0},	// S_FIRE25
    {SPR_FIRE,32775,2,TA_Fire,S_FIRE27,0,0},	// S_FIRE26
    {SPR_FIRE,32774,2,TA_Fire,S_FIRE28,0,0},	// S_FIRE27
    {SPR_FIRE,32775,2,TA_Fire,S_FIRE29,0,0},	// S_FIRE28
    {SPR_FIRE,32774,2,TA_Fire,S_FIRE30,0,0},	// S_FIRE29
    {SPR_FIRE,32775,2,TA_Fire,S_NULL,0,0},	// S_FIRE30
    ...
    {SPR_FATB,32768,2,TA_Tracer,S_TRACER2,0,0},	// S_TRACER
    {SPR_FATB,32769,2,TA_Tracer,S_TRACER,0,0},	// S_TRACER2
    ...
    {SPR_SKEL,0,10,TA_Look,S_SKEL_STND2,0,0},	// S_SKEL_STND
    {SPR_SKEL,1,10,TA_Look,S_SKEL_STND,0,0},	// S_SKEL_STND2
    {SPR_SKEL,0,2,TA_Chase,S_SKEL_RUN2,0,0},	// S_SKEL_RUN1
    {SPR_SKEL,0,2,TA_Chase,S_SKEL_RUN3,0,0},	// S_SKEL_RUN2
    {SPR_SKEL,1,2,TA_Chase,S_SKEL_RUN4,0,0},	// S_SKEL_RUN3
    {SPR_SKEL,1,2,TA_Chase,S_SKEL_RUN5,0,0},	// S_SKEL_RUN4
    {SPR_SKEL,2,2,TA_Chase,S_SKEL_RUN6,0,0},	// S_SKEL_RUN5
    {SPR_SKEL,2,2,TA_Chase,S_SKEL_RUN7,0,0},	// S_SKEL_RUN6
    {SPR_SKEL,3,2,TA_Chase,S_SKEL_RUN8,0,0},	// S_SKEL_RUN7
    {SPR_SKEL,3,2,TA_Chase,S_SKEL_RUN9,0,0},	// S_SKEL_RUN8
    {SPR_SKEL,4,2,TA_Chase,S_SKEL_RUN10,0,0},	// S_SKEL_RUN9
    {SPR_SKEL,4,2,TA_Chase,S_SKEL_RUN11,0,0},	// S_SKEL_RUN10
    {SPR_SKEL,5,2,TA_Chase,S_SKEL_RUN12,0,0},	// S_SKEL_RUN11
    {SPR_SKEL,5,2,TA_Chase,S_SKEL_RUN1,0,0},	// S_SKEL_RUN12
    {SPR_SKEL,6,0,TA_FaceTarget,S_SKEL_FIST2,0,0},	// S_SKEL_FIST1
    {SPR_SKEL,6,6,TA_SkelWhoosh,S_SKEL_FIST3,0,0},	// S_SKEL_FIST2
    {SPR_SKEL,7,6,TA_FaceTarget,S_SKEL_FIST4,0,0},	// S_SKEL_FIST3
    {SPR_SKEL,8,6,TA_SkelFist,S_SKEL_RUN1,0,0},	// S_SKEL_FIST4
    {SPR_SKEL,32777,0,TA_FaceTarget,S_SKEL_MISS2,0,0},	// S_SKEL_MISS1
    {SPR_SKEL,32777,10,TA_FaceTarget,S_SKEL_MISS3,0,0},	// S_SKEL_MISS2
    {SPR_SKEL,10,10,TA_SkelMissile,S_SKEL_MISS4,0,0},	// S_SKEL_MISS3
    {SPR_SKEL,10,10,TA_FaceTarget,S_SKEL_RUN1,0,0},	// S_SKEL_MISS4
    {SPR_SKEL,11,5,0,S_SKEL_PAIN2,0,0},	// S_SKEL_PAIN
    {SPR_SKEL,11,5,TA_Pain,S_SKEL_RUN1,0,0},	// S_SKEL_PAIN2
    {SPR_SKEL,11,7,0,S_SKEL_DIE2,0,0},	// S_SKEL_DIE1
    {SPR_SKEL,12,7,0,S_SKEL_DIE3,0,0},	// S_SKEL_DIE2
    {SPR_SKEL,13,7,TA_Scream,S_SKEL_DIE4,0,0},	// S_SKEL_DIE3
    {SPR_SKEL,14,7,TA_Fall,S_SKEL_DIE5,0,0},	// S_SKEL_DIE4
    ...
    {SPR_FATT,0,15,TA_Look,S_FATT_STND2,0,0},	// S_FATT_STND
    {SPR_FATT,1,15,TA_Look,S_FATT_STND,0,0},	// S_FATT_STND2
    {SPR_FATT,0,4,TA_Chase,S_FATT_RUN2,0,0},	// S_FATT_RUN1
    {SPR_FATT,0,4,TA_Chase,S_FATT_RUN3,0,0},	// S_FATT_RUN2
    {SPR_FATT,1,4,TA_Chase,S_FATT_RUN4,0,0},	// S_FATT_RUN3
    {SPR_FATT,1,4,TA_Chase,S_FATT_RUN5,0,0},	// S_FATT_RUN4
    {SPR_FATT,2,4,TA_Chase,S_FATT_RUN6,0,0},	// S_FATT_RUN5
    {SPR_FATT,2,4,TA_Chase,S_FATT_RUN7,0,0},	// S_FATT_RUN6
    {SPR_FATT,3,4,TA_Chase,S_FATT_RUN8,0,0},	// S_FATT_RUN7
    {SPR_FATT,3,4,TA_Chase,S_FATT_RUN9,0,0},	// S_FATT_RUN8
    {SPR_FATT,4,4,TA_Chase,S_FATT_RUN10,0,0},	// S_FATT_RUN9
    {SPR_FATT,4,4,TA_Chase,S_FATT_RUN11,0,0},	// S_FATT_RUN10
    {SPR_FATT,5,4,TA_Chase,S_FATT_RUN12,0,0},	// S_FATT_RUN11
    {SPR_FATT,5,4,TA_Chase,S_FATT_RUN1,0,0},	// S_FATT_RUN12
    {SPR_FATT,6,20,TA_FatRaise,S_FATT_ATK2,0,0},	// S_FATT_ATK1
    {SPR_FATT,32775,10,TA_FatAttack1,S_FATT_ATK3,0,0},	// S_FATT_ATK2
    {SPR_FATT,8,5,TA_FaceTarget,S_FATT_ATK4,0,0},	// S_FATT_ATK3
    {SPR_FATT,6,5,TA_FaceTarget,S_FATT_ATK5,0,0},	// S_FATT_ATK4
    {SPR_FATT,32775,10,TA_FatAttack2,S_FATT_ATK6,0,0},	// S_FATT_ATK5
    {SPR_FATT,8,5,TA_FaceTarget,S_FATT_ATK7,0,0},	// S_FATT_ATK6
    {SPR_FATT,6,5,TA_FaceTarget,S_FATT_ATK8,0,0},	// S_FATT_ATK7
    {SPR_FATT,32775,10,TA_FatAttack3,S_FATT_ATK9,0,0},	// S_FATT_ATK8
    {SPR_FATT,8,5,TA_FaceTarget,S_FATT_ATK10,0,0},	// S_FATT_ATK9
    {SPR_FATT,6,5,TA_FaceTarget,S_FATT_RUN1,0,0},	// S_FATT_ATK10
    {SPR_FATT,9,3,0,S_FATT_PAIN2,0,0},	// S_FATT_PAIN
    {SPR_FATT,9,3,TA_Pain,S_FATT_RUN1,0,0},	// S_FATT_PAIN2
    {SPR_FATT,10,6,0,S_FATT_DIE2,0,0},	// S_FATT_DIE1
    {SPR_FATT,11,6,TA_Scream,S_FATT_DIE3,0,0},	// S_FATT_DIE2
    {SPR_FATT,12,6,TA_Fall,S_FATT_DIE4,0,0},	// S_FATT_DIE3
    ...
    {SPR_FATT,19,-1,TA_BossDeath,S_NULL,0,0},	// S_FATT_DIE10
    ...
    {SPR_CPOS,0,10,TA_Look,S_CPOS_STND2,0,0},	// S_CPOS_STND
    {SPR_CPOS,1,10,TA_Look,S_CPOS_STND,0,0},	// S_CPOS_STND2
    {SPR_CPOS,0,3,TA_Chase,S_CPOS_RUN2,0,0},	// S_CPOS_RUN1
    {SPR_CPOS,0,3,TA_Chase,S_CPOS_RUN3,0,0},	// S_CPOS_RUN2
    {SPR_CPOS,1,3,TA_Chase,S_CPOS_RUN4,0,0},	// S_CPOS_RUN3
    {SPR_CPOS,1,3,TA_Chase,S_CPOS_RUN5,0,0},	// S_CPOS_RUN4
    {SPR_CPOS,2,3,TA_Chase,S_CPOS_RUN6,0,0},	// S_CPOS_RUN5
    {SPR_CPOS,2,3,TA_Chase,S_CPOS_RUN7,0,0},	// S_CPOS_RUN6
    {SPR_CPOS,3,3,TA_Chase,S_CPOS_RUN8,0,0},	// S_CPOS_RUN7
    {SPR_CPOS,3,3,TA_Chase,S_CPOS_RUN1,0,0},	// S_CPOS_RUN8
    {SPR_CPOS,4,10,TA_FaceTarget,S_CPOS_ATK2,0,0},	// S_CPOS_ATK1
    {SPR_CPOS,32773,4,TA_CPosAttack,S_CPOS_ATK3,0,0},	// S_CPOS_ATK2
    {SPR_CPOS,32772,4,TA_CPosAttack,S_CPOS_ATK4,0,0},	// S_CPOS_ATK3
    {SPR_CPOS,5,1,TA_CPosRefire,S_CPOS_ATK2,0,0},	// S_CPOS_ATK4
    {SPR_CPOS,6,3,0,S_CPOS_PAIN2,0,0},	// S_CPOS_PAIN
    {SPR_CPOS,6,3,TA_Pain,S_CPOS_RUN1,0,0},	// S_CPOS_PAIN2
    {SPR_CPOS,7,5,0,S_CPOS_DIE2,0,0},	// S_CPOS_DIE1
    {SPR_CPOS,8,5,TA_Scream,S_CPOS_DIE3,0,0},	// S_CPOS_DIE2
    {SPR_CPOS,9,5,TA_Fall,S_CPOS_DIE4,0,0},	// S_CPOS_DIE3
    ...
    {SPR_CPOS,15,5,TA_XScream,S_CPOS_XDIE3,0,0},	// S_CPOS_XDIE2
    {SPR_CPOS,16,5,TA_Fall,S_CPOS_XDIE4,0,0},	// S_CPOS_XDIE3
    ...
    {SPR_TROO,0,10,TA_Look,S_TROO_STND2,0,0},	// S_TROO_STND
    {SPR_TROO,1,10,TA_Look,S_TROO_STND,0,0},	// S_TROO_STND2
    {SPR_TROO,0,3,TA_Chase,S_TROO_RUN2,0,0},	// S_TROO_RUN1
    {SPR_TROO,0,3,TA_Chase,S_TROO_RUN3,0,0},	// S_TROO_RUN2
    {SPR_TROO,1,3,TA_Chase,S_TROO_RUN4,0,0},	// S_TROO_RUN3
    {SPR_TROO,1,3,TA_Chase,S_TROO_RUN5,0,0},	// S_TROO_RUN4
    {SPR_TROO,2,3,TA_Chase,S_TROO_RUN6,0,0},	// S_TROO_RUN5
    {SPR_TROO,2,3,TA_Chase,S_TROO_RUN7,0,0},	// S_TROO_RUN6
    {SPR_TROO,3,3,TA_Chase,S_TROO_RUN8,0,0},	// S_TROO_RUN7
    {SPR_TROO,3,3,TA_Chase,S_TROO_RUN1,0,0},	// S_TROO_RUN8
    {SPR_TROO,4,8,TA_FaceTarget,S_TROO_ATK2,0,0},	// S_TROO_ATK1
    {SPR_TROO,5,8,TA_FaceTarget,S_TROO_ATK3,0,0},	// S_TROO_ATK2
    {SPR_TROO,6,6,TA_TroopAttack,S_TROO_RUN1,0,0},	// S_TROO_ATK3
    {SPR_TROO,7,2,0,S_TROO_PAIN2,0,0},	// S_TROO_PAIN
    {SPR_TROO,7,2,TA_Pain,S_TROO_RUN1,0,0},	// S_TROO_PAIN2
    {SPR_TROO,8,8,0,S_TROO_DIE2,0,0},	// S_TROO_DIE1
    {SPR_TROO,9,8,TA_Scream,S_TROO_DIE3,0,0},	// S_TROO_DIE2
    {SPR_TROO,10,6,0,S_TROO_DIE4,0,0},	// S_TROO_DIE3
    {SPR_TROO,11,6,TA_Fall,S_TROO_DIE5,0,0},	// S_TROO_DIE4
    {SPR_TROO,12,-1,0,S_NULL,0,0},	// S_TROO_DIE5
    {SPR_TROO,13,5,0,S_TROO_XDIE2,0,0},	// S_TROO_XDIE1
    {SPR_TROO,14,5,TA_XScream,S_TROO_XDIE3,0,0},	// S_TROO_XDIE2
    {SPR_TROO,15,5,0,S_TROO_XDIE4,0,0},	// S_TROO_XDIE3
    {SPR_TROO,16,5,TA_Fall,S_TROO_XDIE5,0,0},	// S_TROO_XDIE4
    ...
    {SPR_SARG,0,10,TA_Look,S_SARG_STND2,0,0},	// S_SARG_STND
    {SPR_SARG,1,10,TA_Look,S_SARG_STND,0,0},	// S_SARG_STND2
    {SPR_SARG,0,2,TA_Chase,S_SARG_RUN2,0,0},	// S_SARG_RUN1
    {SPR_SARG,0,2,TA_Chase,S_SARG_RUN3,0,0},	// S_SARG_RUN2
    {SPR_SARG,1,2,TA_Chase,S_SARG_RUN4,0,0},	// S_SARG_RUN3
    {SPR_SARG,1,2,TA_Chase,S_SARG_RUN5,0,0},	// S_SARG_RUN4
    {SPR_SARG,2,2,TA_Chase,S_SARG_RUN6,0,0},	// S_SARG_RUN5
    {SPR_SARG,2,2,TA_Chase,S_SARG_RUN7,0,0},	// S_SARG_RUN6
    {SPR_SARG,3,2,TA_Chase,S_SARG_RUN8,0,0},	// S_SARG_RUN7
    {SPR_SARG,3,2,TA_Chase,S_SARG_RUN1,0,0},	// S_SARG_RUN8
    {SPR_SARG,4,8,TA_FaceTarget,S_SARG_ATK2,0,0},	// S_SARG_ATK1
    {SPR_SARG,5,8,TA_FaceTarget,S_SARG_ATK3,0,0},	// S_SARG_ATK2
    {SPR_SARG,6,8,TA_SargAttack,S_SARG_RUN1,0,0},	// S_SARG_ATK3
    {SPR_SARG,7,2,0,S_SARG_PAIN2,0,0},	// S_SARG_PAIN
    {SPR_SARG,7,2,TA_Pain,S_SARG_RUN1,0,0},	// S_SARG_PAIN2
    {SPR_SARG,8,8,0,S_SARG_DIE2,0,0},	// S_SARG_DIE1
    {SPR_SARG,9,8,TA_Scream,S_SARG_DIE3,0,0},	// S_SARG_DIE2
    {SPR_SARG,10,4,0,S_SARG_DIE4,0,0},	// S_SARG_DIE3
    {SPR_SARG,11,4,TA_Fall,S_SARG_DIE5,0,0},	// S_SARG_DIE4
    ...
    {SPR_HEAD,0,10,TA_Look,S_HEAD_STND,0,0},	// S_HEAD_STND
    {SPR_HEAD,0,3,TA_Chase,S_HEAD_RUN1,0,0},	// S_HEAD_RUN1
    {SPR_HEAD,1,5,TA_FaceTarget,S_HEAD_ATK2,0,0},	// S_HEAD_ATK1
    {SPR_HEAD,2,5,TA_FaceTarget,S_HEAD_ATK3,0,0},	// S_HEAD_ATK2
    {SPR_HEAD,32771,5,TA_HeadAttack,S_HEAD_RUN1,0,0},	// S_HEAD_ATK3
    {SPR_HEAD,4,3,0,S_HEAD_PAIN2,0,0},	// S_HEAD_PAIN
    {SPR_HEAD,4,3,TA_Pain,S_HEAD_PAIN3,0,0},	// S_HEAD_PAIN2
    {SPR_HEAD,5,6,0,S_HEAD_RUN1,0,0},	// S_HEAD_PAIN3
    {SPR_HEAD,6,8,0,S_HEAD_DIE2,0,0},	// S_HEAD_DIE1
    {SPR_HEAD,7,8,TA_Scream,S_HEAD_DIE3,0,0},	// S_HEAD_DIE2
    {SPR_HEAD,8,8,0,S_HEAD_DIE4,0,0},	// S_HEAD_DIE3
    {SPR_HEAD,9,8,0,S_HEAD_DIE5,0,0},	// S_HEAD_DIE4
    {SPR_HEAD,10,8,TA_Fall,S_HEAD_DIE6,0,0},	// S_HEAD_DIE5
    ...
    {SPR_BOSS,0,10,TA_Look,S_BOSS_STND2,0,0},	// S_BOSS_STND
    {SPR_BOSS,1,10,TA_Look,S_BOSS_STND,0,0},	// S_BOSS_STND2
    {SPR_BOSS,0,3,TA_Chase,S_BOSS_RUN2,0,0},	// S_BOSS_RUN1
    {SPR_BOSS,0,3,TA_Chase,S_BOSS_RUN3,0,0},	// S_BOSS_RUN2
    {SPR_BOSS,1,3,TA_Chase,S_BOSS_RUN4,0,0},	// S_BOSS_RUN3
    {SPR_BOSS,1,3,TA_Chase,S_BOSS_RUN5,0,0},	// S_BOSS_RUN4
    {SPR_BOSS,2,3,TA_Chase,S_BOSS_RUN6,0,0},	// S_BOSS_RUN5
    {SPR_BOSS,2,3,TA_Chase,S_BOSS_RUN7,0,0},	// S_BOSS_RUN6
    {SPR_BOSS,3,3,TA_Chase,S_BOSS_RUN8,0,0},	// S_BOSS_RUN7
    {SPR_BOSS,3,3,TA_Chase,S_BOSS_RUN1,0,0},	// S_BOSS_RUN8
    {SPR_BOSS,4,8,TA_FaceTarget,S_BOSS_ATK2,0,0},	// S_BOSS_ATK1
    {SPR_BOSS,5,8,TA_FaceTarget,S_BOSS_ATK3,0,0},	// S_BOSS_ATK2
    {SPR_BOSS,6,8,TA_BruisAttack,S_BOSS_RUN1,0,0},	// S_BOSS_ATK3
    {SPR_BOSS,7,2,0,S_BOSS_PAIN2,0,0},	// S_BOSS_PAIN
    {SPR_BOSS,7,2,TA_Pain,S_BOSS_RUN1,0,0},	// S_BOSS_PAIN2
    {SPR_BOSS,8,8,0,S_BOSS_DIE2,0,0},	// S_BOSS_DIE1
    {SPR_BOSS,9,8,TA_Scream,S_BOSS_DIE3,0,0},	// S_BOSS_DIE2
    {SPR_BOSS,10,8,0,S_BOSS_DIE4,0,0},	// S_BOSS_DIE3
    {SPR_BOSS,11,8,TA_Fall,S_BOSS_DIE5,0,0},	// S_BOSS_DIE4
    {SPR_BOSS,12,8,0,S_BOSS_DIE6,0,0},	// S_BOSS_DIE5
    {SPR_BOSS,13,8,0,S_BOSS_DIE7,0,0},	// S_BOSS_DIE6
    {SPR_BOSS,14,-1,TA_BossDeath,S_NULL,0,0},	// S_BOSS_DIE7
    ...
    {SPR_BOS2,0,10,TA_Look,S_BOS2_STND2,0,0},	// S_BOS2_STND
    {SPR_BOS2,1,10,TA_Look,S_BOS2_STND,0,0},	// S_BOS2_STND2
    {SPR_BOS2,0,3,TA_Chase,S_BOS2_RUN2,0,0},	// S_BOS2_RUN1
    {SPR_BOS2,0,3,TA_Chase,S_BOS2_RUN3,0,0},	// S_BOS2_RUN2
    {SPR_BOS2,1,3,TA_Chase,S_BOS2_RUN4,0,0},	// S_BOS2_RUN3
    {SPR_BOS2,1,3,TA_Chase,S_BOS2_RUN5,0,0},	// S_BOS2_RUN4
    {SPR_BOS2,2,3,TA_Chase,S_BOS2_RUN6,0,0},	// S_BOS2_RUN5
    {SPR_BOS2,2,3,TA_Chase,S_BOS2_RUN7,0,0},	// S_BOS2_RUN6
    {SPR_BOS2,3,3,TA_Chase,S_BOS2_RUN8,0,0},	// S_BOS2_RUN7
    {SPR_BOS2,3,3,TA_Chase,S_BOS2_RUN1,0,0},	// S_BOS2_RUN8
    {SPR_BOS2,4,8,TA_FaceTarget,S_BOS2_ATK2,0,0},	// S_BOS2_ATK1
    {SPR_BOS2,5,8,TA_FaceTarget,S_BOS2_ATK3,0,0},	// S_BOS2_ATK2
    {SPR_BOS2,6,8,TA_BruisAttack,S_BOS2_RUN1,0,0},	// S_BOS2_ATK3
    {SPR_BOS2,7,2,0,S_BOS2_PAIN2,0,0},	// S_BOS2_PAIN
    {SPR_BOS2,7,2,TA_Pain,S_BOS2_RUN1,0,0},	// S_BOS2_PAIN2
    {SPR_BOS2,8,8,0,S_BOS2_DIE2,0,0},	// S_BOS2_DIE1
    {SPR_BOS2,9,8,TA_Scream,S_BOS2_DIE3,0,0},	// S_BOS2_DIE2
    {SPR_BOS2,10,8,0,S_BOS2_DIE4,0,0},	// S_BOS2_DIE3
    {SPR_BOS2,11,8,TA_Fall,S_BOS2_DIE5,0,0},	// S_BOS2_DIE4
    ...
    {SPR_SKUL,32768,10,TA_Look,S_SKULL_STND2,0,0},	// S_SKULL_STND
    {SPR_SKUL,32769,10,TA_Look,S_SKULL_STND,0,0},	// S_SKULL_STND2
    {SPR_SKUL,32768,6,TA_Chase,S_SKULL_RUN2,0,0},	// S_SKULL_RUN1
    {SPR_SKUL,32769,6,TA_Chase,S_SKULL_RUN1,0,0},	// S_SKULL_RUN2
    {SPR_SKUL,32770,10,TA_FaceTarget,S_SKULL_ATK2,0,0},	// S_SKULL_ATK1
    {SPR_SKUL,32771,4,TA_SkullAttack,S_SKULL_ATK3,0,0},	// S_SKULL_ATK2
    ...
    {SPR_SKUL,32772,3,TA_Pain,S_SKULL_RUN1,0,0},	// S_SKULL_PAIN2
    {SPR_SKUL,32773,6,0,S_SKULL_DIE2,0,0},	// S_SKULL_DIE1
    {SPR_SKUL,32774,6,TA_Scream,S_SKULL_DIE3,0,0},	// S_SKULL_DIE2
    {SPR_SKUL,32775,6,0,S_SKULL_DIE4,0,0},	// S_SKULL_DIE3
    {SPR_SKUL,32776,6,TA_Fall,S_SKULL_DIE5,0,0},	// S_SKULL_DIE4
    {SPR_SKUL,9,6,0,S_SKULL_DIE6,0,0},	// S_SKULL_DIE5
    {SPR_SKUL,10,6,0,S_NULL,0,0},	// S_SKULL_DIE6
    {SPR_SPID,0,10,TA_Look,S_SPID_STND2,0,0},	// S_SPID_STND
    {SPR_SPID,1,10,TA_Look,S_SPID_STND,0,0},	// S_SPID_STND2
    {SPR_SPID,0,3,TA_Metal,S_SPID_RUN2,0,0},	// S_SPID_RUN1
    {SPR_SPID,0,3,TA_Chase,S_SPID_RUN3,0,0},	// S_SPID_RUN2
    {SPR_SPID,1,3,TA_Chase,S_SPID_RUN4,0,0},	// S_SPID_RUN3
    {SPR_SPID,1,3,TA_Chase,S_SPID_RUN5,0,0},	// S_SPID_RUN4
    {SPR_SPID,2,3,TA_Metal,S_SPID_RUN6,0,0},	// S_SPID_RUN5
    {SPR_SPID,2,3,TA_Chase,S_SPID_RUN7,0,0},	// S_SPID_RUN6
    {SPR_SPID,3,3,TA_Chase,S_SPID_RUN8,0,0},	// S_SPID_RUN7
    {SPR_SPID,3,3,TA_Chase,S_SPID_RUN9,0,0},	// S_SPID_RUN8
    {SPR_SPID,4,3,TA_Metal,S_SPID_RUN10,0,0},	// S_SPID_RUN9
    {SPR_SPID,4,3,TA_Chase,S_SPID_RUN11,0,0},	// S_SPID_RUN10
    {SPR_SPID,5,3,TA_Chase,S_SPID_RUN12,0,0},	// S_SPID_RUN11
    {SPR_SPID,5,3,TA_Chase,S_SPID_RUN1,0,0},	// S_SPID_RUN12
    {SPR_SPID,32768,20,TA_FaceTarget,S_SPID_ATK2,0,0},	// S_SPID_ATK1
    {SPR_SPID,32774,4,TA_SPosAttack,S_SPID_ATK3,0,0},	// S_SPID_ATK2
    {SPR_SPID,32775,4,TA_SPosAttack,S_SPID_ATK4,0,0},	// S_SPID_ATK3
    {SPR_SPID,32775,1,TA_SpidRefire,S_SPID_ATK2,0,0},	// S_SPID_ATK4
    {SPR_SPID,8,3,0,S_SPID_PAIN2,0,0},	// S_SPID_PAIN
    {SPR_SPID,8,3,TA_Pain,S_SPID_RUN1,0,0},	// S_SPID_PAIN2
    {SPR_SPID,9,20,TA_Scream,S_SPID_DIE2,0,0},	// S_SPID_DIE1
    {SPR_SPID,10,10,TA_Fall,S_SPID_DIE3,0,0},	// S_SPID_DIE2
    ...
    {SPR_SPID,18,-1,TA_BossDeath,S_NULL,0,0},	// S_SPID_DIE11
    {SPR_BSPI,0,10,TA_Look,S_BSPI_STND2,0,0},	// S_BSPI_STND
    {SPR_BSPI,1,10,TA_Look,S_BSPI_STND,0,0},	// S_BSPI_STND2
    {SPR_BSPI,0,20,0,S_BSPI_RUN1,0,0},	// S_BSPI_SIGHT
    {SPR_BSPI,0,3,TA_BabyMetal,S_BSPI_RUN2,0,0},	// S_BSPI_RUN1
    {SPR_BSPI,0,3,TA_Chase,S_BSPI_RUN3,0,0},	// S_BSPI_RUN2
    {SPR_BSPI,1,3,TA_Chase,S_BSPI_RUN4,0,0},	// S_BSPI_RUN3
    {SPR_BSPI,1,3,TA_Chase,S_BSPI_RUN5,0,0},	// S_BSPI_RUN4
    {SPR_BSPI,2,3,TA_Chase,S_BSPI_RUN6,0,0},	// S_BSPI_RUN5
    {SPR_BSPI,2,3,TA_Chase,S_BSPI_RUN7,0,0},	// S_BSPI_RUN6
    {SPR_BSPI,3,3,TA_BabyMetal,S_BSPI_RUN8,0,0},	// S_BSPI_RUN7
    {SPR_BSPI,3,3,TA_Chase,S_BSPI_RUN9,0,0},	// S_BSPI_RUN8
    {SPR_BSPI,4,3,TA_Chase,S_BSPI_RUN10,0,0},	// S_BSPI_RUN9
    {SPR_BSPI,4,3,TA_Chase,S_BSPI_RUN11,0,0},	// S_BSPI_RUN10
    {SPR_BSPI,5,3,TA_Chase,S_BSPI_RUN12,0,0},	// S_BSPI_RUN11
    {SPR_BSPI,5,3,TA_Chase,S_BSPI_RUN1,0,0},	// S_BSPI_RUN12
    {SPR_BSPI,32768,20,TA_FaceTarget,S_BSPI_ATK2,0,0},	// S_BSPI_ATK1
    {SPR_BSPI,32774,4,TA_BspiAttack,S_BSPI_ATK3,0,0},	// S_BSPI_ATK2
    {SPR_BSPI,32775,4,0,S_BSPI_ATK4,0,0},	// S_BSPI_ATK3
    {SPR_BSPI,32775,1,TA_SpidRefire,S_BSPI_ATK2,0,0},	// S_BSPI_ATK4
    {SPR_BSPI,8,3,0,S_BSPI_PAIN2,0,0},	// S_BSPI_PAIN
    {SPR_BSPI,8,3,TA_Pain,S_BSPI_RUN1,0,0},	// S_BSPI_PAIN2
    {SPR_BSPI,9,20,TA_Scream,S_BSPI_DIE2,0,0},	// S_BSPI_DIE1
    {SPR_BSPI,10,7,TA_Fall,S_BSPI_DIE3,0,0},	// S_BSPI_DIE2
    ...
    {SPR_BSPI,15,-1,TA_BossDeath,S_NULL,0,0},	// S_BSPI_DIE7
    ...
    {SPR_CYBR,0,10,TA_Look,S_CYBER_STND2,0,0},	// S_CYBER_STND
    {SPR_CYBR,1,10,TA_Look,S_CYBER_STND,0,0},	// S_CYBER_STND2
    {SPR_CYBR,0,3,TA_Hoof,S_CYBER_RUN2,0,0},	// S_CYBER_RUN1
    {SPR_CYBR,0,3,TA_Chase,S_CYBER_RUN3,0,0},	// S_CYBER_RUN2
    {SPR_CYBR,1,3,TA_Chase,S_CYBER_RUN4,0,0},	// S_CYBER_RUN3
    {SPR_CYBR,1,3,TA_Chase,S_CYBER_RUN5,0,0},	// S_CYBER_RUN4
    {SPR_CYBR,2,3,TA_Chase,S_CYBER_RUN6,0,0},	// S_CYBER_RUN5
    {SPR_CYBR,2,3,TA_Chase,S_CYBER_RUN7,0,0},	// S_CYBER_RUN6
    {SPR_CYBR,3,3,TA_Metal,S_CYBER_RUN8,0,0},	// S_CYBER_RUN7
    {SPR_CYBR,3,3,TA_Chase,S_CYBER_RUN1,0,0},	// S_CYBER_RUN8
    {SPR_CYBR,4,6,TA_FaceTarget,S_CYBER_ATK2,0,0},	// S_CYBER_ATK1
    {SPR_CYBR,5,12,TA_CyberAttack,S_CYBER_ATK3,0,0},	// S_CYBER_ATK2
    {SPR_CYBR,4,12,TA_FaceTarget,S_CYBER_ATK4,0,0},	// S_CYBER_ATK3
    {SPR_CYBR,5,12,TA_CyberAttack,S_CYBER_ATK5,0,0},	// S_CYBER_ATK4
    {SPR_CYBR,4,12,TA_FaceTarget,S_CYBER_ATK6,0,0},	// S_CYBER_ATK5
    {SPR_CYBR,5,12,TA_CyberAttack,S_CYBER_RUN1,0,0},	// S_CYBER_ATK6
    {SPR_CYBR,6,10,TA_Pain,S_CYBER_RUN1,0,0},	// S_CYBER_PAIN
    {SPR_CYBR,7,10,0,S_CYBER_DIE2,0,0},	// S_CYBER_DIE1
    {SPR_CYBR,8,10,TA_Scream,S_CYBER_DIE3,0,0},	// S_CYBER_DIE2
    ...
    {SPR_CYBR,12,10,TA_Fall,S_CYBER_DIE7,0,0},	// S_CYBER_DIE6
    ...
    {SPR_CYBR,15,-1,TA_BossDeath,S_NULL,0,0},	// S_CYBER_DIE10
    {SPR_PAIN,0,10,TA_Look,S_PAIN_STND,0,0},	// S_PAIN_STND
    {SPR_PAIN,0,3,TA_Chase,S_PAIN_RUN2,0,0},	// S_PAIN_RUN1
    {SPR_PAIN,0,3,TA_Chase,S_PAIN_RUN3,0,0},	// S_PAIN_RUN2
    {SPR_PAIN,1,3,TA_Chase,S_PAIN_RUN4,0,0},	// S_PAIN_RUN3
    {SPR_PAIN,1,3,TA_Chase,S_PAIN_RUN5,0,0},	// S_PAIN_RUN4
    {SPR_PAIN,2,3,TA_Chase,S_PAIN_RUN6,0,0},	// S_PAIN_RUN5
    {SPR_PAIN,2,3,TA_Chase,S_PAIN_RUN1,0,0},	// S_PAIN_RUN6
    {SPR_PAIN,3,5,TA_FaceTarget,S_PAIN_ATK2,0,0},	// S_PAIN_ATK1
    {SPR_PAIN,4,5,TA_FaceTarget,S_PAIN_ATK3,0,0},	// S_PAIN_ATK2
    {SPR_PAIN,32773,5,TA_FaceTarget,S_PAIN_ATK4,0,0},	// S_PAIN_ATK3
    {SPR_PAIN,32773,0,TA_PainAttack,S_PAIN_RUN1,0,0},	// S_PAIN_ATK4
    {SPR_PAIN,6,6,0,S_PAIN_PAIN2,0,0},	// S_PAIN_PAIN
    {SPR_PAIN,6,6,TA_Pain,S_PAIN_RUN1,0,0},	// S_PAIN_PAIN2
    {SPR_PAIN,32775,8,0,S_PAIN_DIE2,0,0},	// S_PAIN_DIE1
    {SPR_PAIN,32776,8,TA_Scream,S_PAIN_DIE3,0,0},	// S_PAIN_DIE2
    {SPR_PAIN,32777,8,0,S_PAIN_DIE4,0,0},	// S_PAIN_DIE3
    {SPR_PAIN,32778,8,0,S_PAIN_DIE5,0,0},	// S_PAIN_DIE4
    {SPR_PAIN,32779,8,TA_PainDie,S_PAIN_DIE6,0,0},	// S_PAIN_DIE5
    ...
    {SPR_SSWV,0,10,TA_Look,S_SSWV_STND2,0,0},	// S_SSWV_STND
    {SPR_SSWV,1,10,TA_Look,S_SSWV_STND,0,0},	// S_SSWV_STND2
    {SPR_SSWV,0,3,TA_Chase,S_SSWV_RUN2,0,0},	// S_SSWV_RUN1
    {SPR_SSWV,0,3,TA_Chase,S_SSWV_RUN3,0,0},	// S_SSWV_RUN2
    {SPR_SSWV,1,3,TA_Chase,S_SSWV_RUN4,0,0},	// S_SSWV_RUN3
    {SPR_SSWV,1,3,TA_Chase,S_SSWV_RUN5,0,0},	// S_SSWV_RUN4
    {SPR_SSWV,2,3,TA_Chase,S_SSWV_RUN6,0,0},	// S_SSWV_RUN5
    {SPR_SSWV,2,3,TA_Chase,S_SSWV_RUN7,0,0},	// S_SSWV_RUN6
    {SPR_SSWV,3,3,TA_Chase,S_SSWV_RUN8,0,0},	// S_SSWV_RUN7
    {SPR_SSWV,3,3,TA_Chase,S_SSWV_RUN1,0,0},	// S_SSWV_RUN8
    {SPR_SSWV,4,10,TA_FaceTarget,S_SSWV_ATK2,0,0},	// S_SSWV_ATK1
    {SPR_SSWV,5,10,TA_FaceTarget,S_SSWV_ATK3,0,0},	// S_SSWV_ATK2
    {SPR_SSWV,32774,4,TA_CPosAttack,S_SSWV_ATK4,0,0},	// S_SSWV_ATK3
    {SPR_SSWV,5,6,TA_FaceTarget,S_SSWV_ATK5,0,0},	// S_SSWV_ATK4
    {SPR_SSWV,32774,4,TA_CPosAttack,S_SSWV_ATK6,0,0},	// S_SSWV_ATK5
    {SPR_SSWV,5,1,TA_CPosRefire,S_SSWV_ATK2,0,0},	// S_SSWV_ATK6
    {SPR_SSWV,7,3,0,S_SSWV_PAIN2,0,0},	// S_SSWV_PAIN
    {SPR_SSWV,7,3,TA_Pain,S_SSWV_RUN1,0,0},	// S_SSWV_PAIN2
    {SPR_SSWV,8,5,0,S_SSWV_DIE2,0,0},	// S_SSWV_DIE1
    {SPR_SSWV,9,5,TA_Scream,S_SSWV_DIE3,0,0},	// S_SSWV_DIE2
    {SPR_SSWV,10,5,TA_Fall,S_SSWV_DIE4,0,0},	// S_SSWV_DIE3
    ...
    {SPR_SSWV,14,5,TA_XScream,S_SSWV_XDIE3,0,0},	// S_SSWV_XDIE2
    {SPR_SSWV,15,5,TA_Fall,S_SSWV_XDIE4,0,0},	// S_SSWV_XDIE3
    ...
    {SPR_KEEN,2,6,TA_Scream,S_COMMKEEN4,0,0},	// S_COMMKEEN3
    ...
    {SPR_KEEN,10,6,TA_KeenDie,S_COMMKEEN12,0,0},// S_COMMKEEN11
    {SPR_KEEN,11,-1,0,S_NULL,0,0},		// S_COMMKEEN12
    {SPR_KEEN,12,4,0,S_KEENPAIN2,0,0},	// S_KEENPAIN
    {SPR_KEEN,12,8,TA_Pain,S_KEENSTND,0,0},	// S_KEENPAIN2
    {SPR_BBRN,0,-1,0,S_NULL,0,0},		// S_BRAIN
    {SPR_BBRN,1,36,TA_BrainPain,S_BRAIN,0,0},	// S_BRAIN_PAIN
    {SPR_BBRN,0,100,TA_BrainScream,S_BRAIN_DIE2,0,0},	// S_BRAIN_DIE1
    {SPR_BBRN,0,10,0,S_BRAIN_DIE3,0,0},	// S_BRAIN_DIE2
    {SPR_BBRN,0,10,0,S_BRAIN_DIE4,0,0},	// S_BRAIN_DIE3
    {SPR_BBRN,0,-1,TA_BrainDie,S_NULL,0,0},	// S_BRAIN_DIE4
    {SPR_SSWV,0,10,TA_Look,S_BRAINEYE,0,0},	// S_BRAINEYE
    {SPR_SSWV,0,181,TA_BrainAwake,S_BRAINEYE1,0,0},	// S_BRAINEYESEE
    {SPR_SSWV,0,150,TA_BrainSpit,S_BRAINEYE1,0,0},	// S_BRAINEYE1
    {SPR_BOSF,32768,3,TA_SpawnSound,S_SPAWN2,0,0},	// S_SPAWN1
    {SPR_BOSF,32769,3,TA_SpawnFly,S_SPAWN3,0,0},	// S_SPAWN2
    {SPR_BOSF,32770,3,TA_SpawnFly,S_SPAWN4,0,0},	// S_SPAWN3
    {SPR_BOSF,32771,3,TA_SpawnFly,S_SPAWN1,0,0},	// S_SPAWN4
    {SPR_FIRE,32768,4,TA_Fire,S_SPAWNFIRE2,0,0},	// S_SPAWNFIRE1
    {SPR_FIRE,32769,4,TA_Fire,S_SPAWNFIRE3,0,0},	// S_SPAWNFIRE2
    {SPR_FIRE,32770,4,TA_Fire,S_SPAWNFIRE4,0,0},	// S_SPAWNFIRE3
    {SPR_FIRE,32771,4,TA_Fire,S_SPAWNFIRE5,0,0},	// S_SPAWNFIRE4
    {SPR_FIRE,32772,4,TA_Fire,S_SPAWNFIRE6,0,0},	// S_SPAWNFIRE5
    {SPR_FIRE,32773,4,TA_Fire,S_SPAWNFIRE7,0,0},	// S_SPAWNFIRE6
    {SPR_FIRE,32774,4,TA_Fire,S_SPAWNFIRE8,0,0},	// S_SPAWNFIRE7
    {SPR_FIRE,32775,4,TA_Fire,S_NULL,0,0},		// S_SPAWNFIRE8
    {SPR_MISL,32769,10,0,S_BRAINEXPLODE2,0,0},	// S_BRAINEXPLODE1
    {SPR_MISL,32770,10,0,S_BRAINEXPLODE3,0,0},	// S_BRAINEXPLODE2
    {SPR_MISL,32771,10,TA_BrainExplode,S_NULL,0,0},	// S_BRAINEXPLODE3
    ...
    {SPR_BEXP,32769,5,TA_Scream,S_BEXP3,0,0},	// S_BEXP2
    {SPR_BEXP,32770,5,0,S_BEXP4,0,0},	// S_BEXP3
    {SPR_BEXP,32771,10,TA_Explode,S_BEXP5,0,0},	// S_BEXP4
